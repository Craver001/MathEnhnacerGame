...
class Basic_Division : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_primary_division)
        ...
        buttonOK.setOnClickListener {
            ...
            if (input == "") Toast.makeText(
                ...
                if (userLife==0){
                    ...
                    val intent = Intent(this@Basic_Division,finalScore::class.java)
    ...
    fun PrimaryGameAddition(){
        ...
        val number1 =  Random.nextInt(10,60)
